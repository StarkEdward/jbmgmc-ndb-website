...
The department actively conducts academic activities including seminars, case presentations, journal clubs, simulation-based training sessions, and skill-based workshops in accordance with the Competency-Based Medical Education (CBME) curriculum. Emphasis is laid on ethical practice, patient safety, teamwork, and evidence-based decision-making.

### Curriculum Overview

As per NMC and MUHS – [Download Syllabus](http://www.muhs.ac.in/upload/syllabus)
...
- Pre-anaesthetic evaluation and risk assessment.
...
- Fluid management and perioperative monitoring.
- Post-operative care and pain management.
- Management of shock and common emergencies.
- Early clinical exposure and skill laboratory sessions form an integral component of learning.

#### 2. Postgraduate Training (MD Anaesthesiology)
The postgraduate program focuses on:
- Advanced airway and difficult airway management.
- Subspecialty anaesthesia (neuro, cardiac, paediatric, obstetric, onco-anaesthesia).
- Critical care medicine and ventilatory management.
- Trauma and emergency anaesthesia.
- Acute and chronic pain services.
- Research methodology and dissertation work.
- Ethics, communication skills, and interdepartmental coordination.`,
...
if (index !== -1) {
  ...
  console.log('Successfully formatted Anaesthesiology markdown in db.json');
} else {
