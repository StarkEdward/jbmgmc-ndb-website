          ...
          <form onSubmit={handleSaveSecurity} className="space-y-4">
            ...
            <div className="flex justify-end pt-4">
              <button
                type="submit"
                disabled={isPending}
                className="flex items-center gap-2 rounded-xl bg-teal-500 px-5 py-2.5 text-sm font-bold text-white hover:bg-teal-600 disabled:opacity-50 transition-all cursor-pointer shadow-sm shadow-teal-500/20"
              >
                {isPending ? (
                  <>
