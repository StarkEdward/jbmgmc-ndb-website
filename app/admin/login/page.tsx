    ...
    >
      ...
      <div className="relative z-10 flex w-full h-screen flex-col lg:flex-row">
        ...
        <div className="w-full lg:w-[40%] h-full flex flex-col justify-center px-6 sm:px-12 xl:px-20 bg-slate-950/60 backdrop-blur-2xl border-t lg:border-t-0 lg:border-l border-white/10 shadow-[-20px_0_40px_rgba(0,0,0,0.5)] relative">
          {/* Subtle teal glow behind form (significantly reduced) */}
          <div className="absolute top-1/2 left-1/2 -z-10 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-teal-500/5 blur-[120px] pointer-events-none" />
          ...
          <div className="w-full max-w-sm mx-auto relative z-10">
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <div className="absolute inset-y-0 right-0 flex items-center pr-4">
                    ...
                    >
                      <ShieldCheck className={`h-5 w-5 transition-colors ${showPassword ? 'text-red-500' : 'text-emerald-500 hover:text-emerald-400'}`} />
                    </button>
                  </div>
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={isPending}
                className="flex w-full items-center justify-center gap-2 rounded-2xl bg-teal-500 py-4 text-sm font-bold text-slate-950 shadow-[0_0_20px_rgba(20,184,166,0.2)] hover:bg-teal-400 active:scale-[0.98] transition-all disabled:opacity-50 disabled:active:scale-100 cursor-pointer mt-4"
              >
                {isPending ? (
                  <>
